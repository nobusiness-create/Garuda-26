...
The resulting confidence is a **rule-based assessment score**, not a calibrated probability.
...
This allows survivor detections from the perception layer to become navigation targets.
...
This moves the system beyond simply detecting people to deciding **which survivor should be investigated first**.
...
Live physical hazard sensing is not currently integrated.
...
**Status:** `IMPLEMENTED IN SOFTWARE / SIMULATED INPUTS`
...
| MAVLink physical command execution | **FUTURE INTEGRATION**                  |
...
│   ├── ai_fusion_connector.py
│   ├── audio_distress_module.py
│   ├── uwb_radar_module.py
│   ├── survivor_assessment.py
│   ├── coordinate_bridge.py
│   ├── navigation_integration.py
│   ├── multi_survivor_navigation.py
│   ├── dynamic_replanning_demo.py
│   ├── ai_to_navigation_pipeline.py
│   ├── ai_flight_control_pipeline.py
...
│
├── audio_tests/
│   ├── freesound_community-experimental-64402.wav
│   ├── freesound_community-help-echo-81995.wav
│   └── freesound_community-radio-static-6382.wav
│
├── .gitignore
└── README.md
```
...
This repository contains the software prototype and integration work developed for **SIH26177**.

The repository intentionally distinguishes between:

* **Implemented software**
* **Simulation/test interfaces**
* **Future hardware integration**

This distinction is important because several sensing components are currently validated at the software level rather than through physical hardware.

---

# Team Contribution

GARUDA is a team project.

My primary contribution focused on **AI perception and system integration**, including:

* RGB/YOLO perception
* Person tracking
* RGB + thermal fusion integration
* Audio distress pipeline
* Unified perception output
* Survivor assessment
* UWB software integration
* Coordinate transformation
* Navigation integration
* Multi-survivor prioritization integration
* Adaptive speed and altitude integration
* End-to-end AI pipeline integration
* System-level testing and debugging

The UWB processing and adaptive flight-control modules were initially provided as basic implementations by a team member. They were integrated and connected to the wider GARUDA decision pipeline as part of the system-level implementation.

The navigation algorithms and other team modules are retained as collaborative project work and are not presented as individually authored components.
...
7. MAVLink/ArduPilot integration is intended as the next system-integration stage.
8. No physical drone flight validation has been performed in this repository.
...
* Connect live MAVLink telemetry
* Connect perception outputs to ArduPilot
* Replace simulated drone state with live telemetry
...
**SIH26177 | Smart India Hackathon 2026**
